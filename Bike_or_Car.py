...
classifier.fit(training_set, steps_per_epoch=10, epochs=10, validation_data=test_set, validation_steps=1)
# Classification example with CNN and prediction
import numpy as np
from tensorflow.keras.preprocessing import image
test_image = image.load_img('.../dataset/test_image.jpg', target_size=(64,64))
